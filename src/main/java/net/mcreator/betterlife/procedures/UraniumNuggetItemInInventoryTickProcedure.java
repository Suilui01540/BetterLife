...
public class UraniumNuggetItemInInventoryTickProcedure {
				...
				if (!((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY)
					...
					if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(BetterlifeModMobEffects.RADIOACTIVE_DECAY.get())
						...
						if (entity instanceof LivingEntity _entity)
							_entity.addEffect(new MobEffectInstance(BetterlifeModMobEffects.RADIOACTIVE_DECAY.get(), 30, 1, (false), (true)));
					}
				}
			}
		}
